"""
URL configuration for kina_backend project.
...
urlpatterns = [
    ...
    path('api/token/', TokenObtainPairViewWithTag.as_view(), name='token_obtain_pair'),
    path('api/token/refresh/', TokenRefreshViewWithTag.as_view(), name='token_refresh'),
